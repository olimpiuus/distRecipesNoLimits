...
const Head = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("title", { children: recipeData.mealId ? recipeData.SEOTitle ? recipeData.SEOTitle : recipeData.mealId.name : recipeData.name }),
    /* @__PURE__ */ jsx("meta", { name: "og:title", content: recipeData.mealId ? recipeData.SEOTitle ? recipeData.SEOTitle : recipeData.mealId.name : recipeData.name }),
    /* @__PURE__ */ jsx("meta", { name: "description", content: recipeData.mealId ? recipeData.SEODescription : recipeData.quickTastyDescription }),
    /* @__PURE__ */ jsx("meta", { name: "og:description", content: recipeData.mealId ? recipeData.SEODescription : recipeData.quickTastyDescription }),
    /* @__PURE__ */ jsx("meta", { property: "og:image", content: recipeData.mealId ? `https://www.recipesnolimits.com${recipeData.mealId.imageUrl}` : `https://www.recipesnolimits.com${recipeData.imageUrl}` }),
    !recipeData.mealId && /* @__PURE__ */ jsx("meta", { name: "robots", content: "noindex, nofollow" })
  ] });
};
...
function Page() {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-4 py-8 bg-white rounded-lg", children: [
    /* @__PURE__ */ jsx(
      "script",
      {
...
const configValuesSerialized = {
  ...
  ["Head"]: {
    type: "cumulative",
    definedAtData: [{ "filePathToShowToUser": "/pages/recipes/@id/+Head.jsx", "fileExportPathToShowToUser": [] }, { "filePathToShowToUser": "/pages/+Head.jsx", "fileExportPathToShowToUser": [] }],
    valueSerialized: [{
      type: "plus-file",
